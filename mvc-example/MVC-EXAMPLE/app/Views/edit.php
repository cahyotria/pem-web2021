	...
	<body>
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-4"><h3>Update Data Anda Di Sini</h3>
					<form method="post" action="/mvc-example/?act=simpan_update">
					  ...
					  <button type="submit" value="simpanData" class="btn btn-default">Submit</button>
					</form>
					<br/>
